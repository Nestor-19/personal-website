    ...
    <>
        <div style={{backgroundImage: `url(${Shell})`}} className='flex justify-center items-center group container rounded-lg mx-auto div-content' id='shell'>
            <div className='opacity-0 group-hover:opacity-100'>
                <span className='text-xl font-bold text-white tracking-wider pl-2 flex flex-row gap-3'>
                    MyShell
                </span>
                <div className='pt-4 pl-2  text-gray-300 text-[93%]'>
        ...
        <div style={{backgroundImage: `url(${RMS})`}} className='flex justify-center items-center group container rounded-lg mx-auto div-content' id='store'>
            <div className='opacity-0 group-hover:opacity-100'>
                <span className='text-md sm:text-xl font-bold text-white tracking-wider pl-2 flex flex-row gap-3'>
                  Retail Management System
                </span>
                <div className='pt-4 pl-2  text-gray-300 text-[93%] sm:text-lg'>
